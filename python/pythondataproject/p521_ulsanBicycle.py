import json, urllib.request, datetime, math, os.path
import pandas as pd
...
def getBicycleData(pageNo, numofRows):
    endpoint = 'http://apis.data.go.kr/6310000/ulsanbicyclepath/getUlsanbicyclepathList'
    
    parameters = ''
    parameters += '?serviceKey='+get_secret('ulsan_data_apiKey')
...
myframe.to_csv(savedFilename, index=False)
